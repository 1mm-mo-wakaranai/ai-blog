...
![ChatGPT SNS投稿 理解度の変化](images/comparison-before-after.png)
...
## 実際にChatGPTでSNS投稿を作ってみた！（筆者の体験）

筆者がX（旧Twitter）の投稿文をChatGPTに作ってもらい始めて感じたことです。

### 良かった点

- 140文字に収める作業が楽。「この内容を140文字以内のツイートにして」で一発
- ハッシュタグの提案もしてくれる
- 複数パターン出してもらって、一番しっくりくるものを選べる

### 注意が必要な点

- **そのまま投稿するとAI臭が出る**。必ず自分の言葉で書き直す
- **「w」や「草」などの生きた言葉は出てこない**。自分で足す
- **最新のネタには対応できない**。リアルタイムの話題は自分で書く


### 筆者の投稿作成フロー

1. 伝えたい内容を箇条書きで3行書く
2. ChatGPTに「この内容を140文字のツイートにして。3パターン出して」と依頼
3. 3パターンの中から一番しっくりくるものを選ぶ
4. 自分の言葉でニュアンスを微調整
5. 投稿

この流れで1投稿あたり2〜3分。以前は10分以上かかっていたので、かなりの時短です。
