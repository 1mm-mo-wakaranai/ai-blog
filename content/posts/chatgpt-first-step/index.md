...
![ChatGPTの始め方 理解度の変化](images/comparison-before-after.png)
...
## 実際にChatGPTを初めて使ったときの感想

筆者がChatGPTを初めて使ったのは2023年。最初の質問は「明日の天気を教えて」でした（当時は検索機能がなかったので的外れでしたが）。

それから2年以上使い続けて感じるのは、**最初の10分で「使い方のコツ」が分かるかどうかで、その後の活用度が全く変わる**ということ。

この記事で紹介した「具体的に指示する」「役割を与える」の2つだけ覚えて使い始めれば、1週間後には「ChatGPTなしでは仕事にならない」と感じるはずです。


### 筆者おすすめの「最初の3つの質問」

ChatGPTを初めて使う人に筆者がおすすめする最初の質問はこの3つです：

1. 「明日の朝食のメニューを3つ提案して。材料は卵とパンがあります」→ AIの提案力を体感
2. 「以下のメールを丁寧な敬語に直してください：（自分の文章を貼る）」→ 実用性を体感
3. 「プログラミングを始めたい初心者です。何から始めればいいですか？」→ 対話力を体感
