...
![ChatGPTブレスト術 理解度の変化](images/comparison-before-after.png)
...
## 実際にChatGPTでブレストしてみた！（筆者の体験）

筆者がブログのネタ出しで行き詰まったとき、ChatGPTに「AIブログのネタを20個出して」と聞いてみた結果です。

20個中、使えそうなものは5〜6個。残りは既に書いた内容と被っていたり、ニッチすぎたり。でも**ゼロから自分で考えるより圧倒的に早い**のは事実です。

### ブレストでChatGPTを上手に使うコツ

1. 「○○のネタを20個出して」と多めに依頼する（5個だと微妙なものばかり出がち）
2. 良さそうなものがあったら「3番を深掘りして」と追加質問
3. 「それぞれのターゲット読者と検索されそうなキーワードも教えて」で実用性を確認


### ブレストの質を上げるプロンプトのコツ

- 「○○について」ではなく「○○で困っている30代会社員向けの」と読者像を具体的に
- 「アイデアを出して」ではなく「20個出して。うち5個は意外性のあるものにして」
- 「このアイデアの弱点は？」と自分のアイデアを批判してもらうのも有効
