...
- **Esc**: 提案をスキップする
- **Ctrl+I**: Copilot Chatを開く（VS Code内）
- **コメントを書く→待つ→Tabで採用**: これがAIコーディングの基本ループ

AIコーディングは「難しいプログラミングスキル」ではなく「AIとの対話スキル」です。プログラミング経験ゼロでも、日本語でやりたいことを伝えれば始められます。

### AIコーディングアシスタントを選ぶときの判断フロー

1. **今のエディタを変えたくない？** → GitHub Copilot
2. **AIにガッツリ書いてほしい？** → Cursor
3. **設計から丁寧にやりたい？** → Kiro
4. **全部無料で試したい？** → 3つとも無料プランがあるので順番に試す

迷ったらまずGitHub Copilotから。VS Codeに拡張を入れるだけなので、環境を変えるリスクがゼロです。


まずは今日、5分だけ時間を取って試してみてください。
