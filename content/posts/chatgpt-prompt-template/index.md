...
![ChatGPTプロンプト 理解度の変化](images/comparison-before-after.png)
...
## 実際にプロンプトテンプレートを使ってみた！（筆者の体験）

筆者がプロンプトテンプレートを使い始めてから、ChatGPTの回答品質が劇的に変わりました。

### Before（テンプレートなし）

「ブログ記事を書いて」→ 汎用的で使えない文章が出てくる

### After（テンプレートあり）

「以下の条件でブログ記事を書いてください。読者: AI初心者の30代。文体: ですます調。文字数: 3000字。構成: 導入→本論→まとめ。キーワード: ChatGPT 使い方」→ そのまま使えるレベルの記事が出てくる

### テンプレートの有無で変わる回答品質

| 項目 | テンプレートなし | テンプレートあり |
|------|---------------|---------------|
| 回答の的確さ | 30% | 80% |
| やり直し回数 | 3〜5回 | 0〜1回 |
| 作業時間 | 30分 | 10分 |

テンプレートは1回作れば何度でも使い回せます。「毎回同じような指示を書いている」と感じたら、それをテンプレート化するサイン。最初の5分の投資で、以後の全ての作業が効率化されます。よく使うテンプレートはメモアプリに保存しておくのがおすすめです。
...
1. この記事のテンプレートを1つコピーして、自分用に書き換える
2. メモアプリ（Notion、Apple Notes等）に保存しておく
3. 次にChatGPTを使うときにテンプレートを貼り付けてから質問する
4. 「いつもより良い回答が返ってきた」と感じたら、そのテンプレートを保存・改善していく
