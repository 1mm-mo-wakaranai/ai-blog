...
Geminiがカレンダーに予定を追加してくれます（確認画面が表示されるので、内容を確認してから確定します）。AIを使ったスケジュール管理に興味がある方は、[AIでスケジュール管理を自動化する方法](/posts/ai-schedule-management/)もあわせてご覧ください。
...
Google AIをもっと活用したい方へ：

<!-- START MoshimoAffiliateEasyLink --><script type="text/javascript">(function(b,c,f,g,a,d,e){b.MoshimoAffiliateObject=a;b[a]=b[a]||function(){arguments.currentScript=c.currentScript||c.scripts[c.scripts.length-2];(b[a].q=b[a].q||[]).push(arguments)};c.getElementById(a)||(d=c.createElement(f),d.src=g,d.id=a,e=c.getElementsByTagName("body")[0],e.appendChild(d))})(window,document,"script","//dn.msmstatic.com/site/cardlink/bundle.js?20220329","msmaflink");msmaflink({"n":"Gemini API プログラミング入門","b":"","t":"","d":"https:\/\/thumbnail.image.rakuten.co.jp","c_p":"","p":[""],"u":{"u":"https:\/\/search.rakuten.co.jp\/search\/mall\/Gemini%20Google%20AI%20%E6%B4%BB%E7%94%A8\/","t":"rakuten","r_v":""},"v":"2.1","b_l":[{"id":1,"u_tx":"楽天市場で見る","u_bc":"#f76956","u_url":"https:\/\/search.rakuten.co.jp\/search\/mall\/Gemini%20Google%20AI%20%E6%B4%BB%E7%94%A8\/","a_id":5490814,"p_id":54,"pl_id":27059,"pc_id":54,"s_n":"rakuten","u_so":1}],"eid":"8Bsdv","s":"s"});</script><div id="msmaflink-8Bsdv">リンク</div><!-- MoshimoAffiliateEasyLink END -->
<!-- /affiliate -->
