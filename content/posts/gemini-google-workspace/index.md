...
![Gemini Workspace連携 理解度の変化](images/comparison-before-after.png)



---

## 実際にGemini × Google Workspaceを使ってみた！（筆者の体験）

筆者が仕事でGemini in Google Workspaceを使ってみて最も便利だったのは**Gmailの返信下書き生成**でした。

長文の問い合わせメールに対して「丁寧に断る」とだけ指示すると、敬語を使った適切な断りの文面を作ってくれます。そこから自分の言葉で微修正して送信。メール返信にかかる時間が半分以下になりました。

### Google Docsでの活用

「この議事録を箇条書きの3行にまとめて」と指示するだけで要約してくれるのも便利。会議後の共有作業が格段に楽になりました。


### 導入のハードル

- Google Workspace Business Standard以上のプランが必要（個人のGmailアカウントでは使えない機能あり）
- 管理者がGemini機能を有効にする必要がある
- 2026年時点ではまだ英語の方が精度が高い場面もある


### Geminiが使えるWorkspaceプラン

| プラン | Gemini利用 | 月額目安 |
|--------|-----------|---------|
| Business Starter | △（一部機能のみ） | 680円/人 |
| Business Standard | ○ | 1,360円/人 |
| Business Plus | ◎ | 2,040円/人 |
| Enterprise | ◎（全機能） | 要問合せ |

Google Workspaceユーザーなら試す価値は十分にあります。まずはGmailの返信生成から試してみてください。
